...
public class HeapPage implements Page {
    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
        ...
        this.numSlots = getNumTuples(this.td);
        DataInputStream dis = new DataInputStream(new ByteArrayInputStream(data));

        // allocate and read the header slots of this page
        header = new byte[getHeaderSize(this.numSlots)];
    ...
    */
    private int getNumTuples(TupleDesc tupleDesc) {        
     ...
     */
    private int getHeaderSize(int numberOfTupleSlots) {        
        // TODO: some code goes here
	// hint!! See the formula in the assignment description PPT.
	...
	if (!(t.getTupleDesc().equals(td))) {
        ...
        int emptySlotIndex = getNextTupleIndexOfValue(0, numSlots, false);
        if (emptySlotIndex == numSlots) {
            throw new DbException("No empty slots available for Tuple insertion.");
        }
        t.setRecordId(new RecordId(pid, emptySlotIndex));
	...
	// hint!! List provide iterator method
        return new Iterator<Tuple>() {
            ...
            int maxIndex = tuples.length;
            int currentIndex = getNextTupleIndexOfValue(0, maxIndex, true);
            ...
            public Tuple next() {
                Tuple tuple = tuples[currentIndex];
                currentIndex = getNextTupleIndexOfValue(currentIndex + 1, maxIndex, true);
                return tuple;
            }
